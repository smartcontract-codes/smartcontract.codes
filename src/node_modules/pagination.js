...
function pagination ({ count, cardsCount = 8 /* cards per page */ }, notify) {
  ...
  const datas = contracts.reduce((containers, el, i) => {
    containers[Math.floor(i / cardsCount)].push(el)
    return containers
  ...
  return el
  function select (e) {
    selectPage(e, collectionContainer, 1)
  }
  function prev (e) {
    goToPrevious(ops, collectionContainer, pages)
  }
  function next (e) {
    goToNext(ops, collectionContainer, pages)
  }
  function addPages (container, pages) {
